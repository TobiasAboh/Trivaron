        ...
        <div className="flex flex-col justify-end w-full md:w-5/6">
          ...
          <div className="absolute text-white pb-4 pl-4 pr-2 md:pr-0 md:pl-6 space-y-6">
            ...
            <p className="text-sm">
              ...
              make informed decisions every step of <br className="block md:hidden" /> the way
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-10 md:justify-between">
          <div className="flex flex-col justify-end">
            ...
            <div className="absolute text-white pb-4 pl-6 space-y-6">
              <h1 className="text-xl md:text-3xl font-bold">Client-First Approach</h1>
              <p className="text-sm">
                Your satisfaction is our priority. We're committed
                <br className="hidden md:block" /> to delivering exceptional<br className="block md:hidden" /> service everytime
              </p>
            </div>
          </div>
          <div className="flex flex-col justify-end">
            ...
            />
            <div className="absolute text-white pb-4 pl-6 space-y-6">
              <h1 className="text-xl md:text-3xl font-bold">Market Expertise</h1>
              <p className="text-sm">
                With deep knowledge of the market, we connect
                <br className="hidden md:block" />{" "}
                you to the best opportunities <br className="block md:hidden"/>available.
              </p>
            </div>
          </div>
        </div>
